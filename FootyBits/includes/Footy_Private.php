...
// $incdir now set up in calling page
// $incdir="../FootyBits/includes/";
$CSSdir="http://www.pretronix.co.uk/Footy/CSS/";
$imgdir="http://www.pretronix.co.uk/Footy/images/";
//$qrydir is now relative to the Includes directory
...
echo "<a href=\"http://www.pretronix.co.uk/Footy.php?logout=1\">Logout</a>\n";
//echo "<br />\n";
//echo "<br />\n";
...
//	echo "<th align=right><img src=\"".$imgdir.$CompLogo[$comp]."\">\n";
	print "<th align=right><img src=\"".$CompLogo[$comp]."\" height=\"40px\">\n";
}
