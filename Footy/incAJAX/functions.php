...
function view_menu_item ($ViewID) {
  ...
  $Ret  = "<tr><td bgcolor=".($view==$ViewID ? $selbg : $normbg);
  $Ret .= "><a href=\"".$_SERVER['PHP_SELF']."?season=".$season."&comp=".$comp;
  $Ret .= "&view=".$ViewID."\"><img src=\"".$imgdir.$ViewImage."_menu_".($view==$ViewID ? "selected" : "normal").".gif\" ALT=\"".$ViewText."\"></a>\n";
